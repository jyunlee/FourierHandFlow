...
class ONet(BaseModule):
    def __init__(self, num_joints, point_feature_len, hidden_size, no_cycle=False):
        ...
        self.c_dim = 120 #point_feature_len + 1  # + 1 for the cycle-distance feature
    ...
    def forward(self, can_points, local_point_feature, cycle_distance, bn=True):
